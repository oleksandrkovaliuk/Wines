...
export const DeleteUserSVG = ({deleteFn}) => {
    return (
        <svg onClick={deleteFn} className="delete-user" fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 290 290">
            <g id="XMLID_24_">
                <g id="XMLID_29_">
